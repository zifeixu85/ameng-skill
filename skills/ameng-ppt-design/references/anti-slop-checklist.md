...
- [ ] **默认禁蓝**（淡蓝 / 靛蓝 / 青蓝任何变体）。唯一例外：`blueprint` 汇报主题，且永不做旗舰默认。
...
| **P1** | AI tell（标题装饰线 / 清一色卡片 / 紫渐变 / 禁用字体 / 蓝（非 blueprint）/ eyebrow 滥用 / 编号滥用 / buzzword / em-dash≥5） | **应改** |
...
5. **出现了禁用字体 / 蓝色（非 blueprint）/ 紫渐变 / 标题装饰线 / 清一色卡片网格了吗？**（有任何一个 → 判负，重做该页）
